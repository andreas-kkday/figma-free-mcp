...
function presentNode(node: AgentNode): AgentNode & { effectiveChildIds: string[] } { return { ...node, effectiveChildIds: effectiveChildIds(node) }; }
