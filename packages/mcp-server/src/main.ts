...
import { buildNodeContext, composeBundleVectorGroupSvg, inspectNode, resolveNodeReference, searchNodes, type AgentDocument } from '@figctx/core';
...
server.registerTool(publicToolNames.getStyleTokens, { description: 'Read extracted token files and font requirements.' }, async () => text({ ...Object.fromEntries(tokenFiles), fonts: fontFile }));
